...
public class ProfessorEndpointsTest {
    ...
    @InjectMocks
    private ProfessorEndpoints professorEndpoints;
    ...
    public void testGetProfessor_Found() {
        ...
        Professor gotProf = professorEndpoints.get(id);
    ...
    public void testSearchProfessor_All() {
        ...
        List<Professor> gotProfs = professorEndpoints.search(query, courseId);
    ...
    public void testCreateProfessor() {
        ...
        ApiObjectCreated response = professorEndpoints.create(prof);
    ...
    public void testDeleteProfessor_Found() {
        ...
        ApiOk response = professorEndpoints.delete(id);
    ...
    public void testUpdateProfessor_Found() {
        ...
        ApiOk response = professorEndpoints.update(prof);
    ...
    public void testUpdateProfessor_NotFound() {
        ...
        NotFoundException exception = assertThrows(NotFoundException.class,
                () -> professorEndpoints.update(prof));
    ...
    public void testListTeachings() {
        ...
        List<Teaching> gotTeachings = professorEndpoints.listTeachings(profId);
