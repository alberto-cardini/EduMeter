...
public class ReportEndpointsTest {
    ...
    @InjectMocks
    private ReportEndpoints reportEndpoints;
    ...
    public void testGetAll() {
        ...
        List<Report> gotReports = reportEndpoints.getAll();
    ...
    public void testGet_Found() {
        ...
        Report gotReport = reportEndpoints.get(reportId);
    ...
    public void testCreate() {
        ...
        ApiObjectCreated response = reportEndpoints.create(securityContext, report);
    ...
    public void testDelete_Found() {
        ...
        ApiOk response = reportEndpoints.delete(reportId);
    ...
    public void testDelete_NotFound() {
        ...
        NotFoundException exception = assertThrows(NotFoundException.class,
                () -> reportEndpoints.delete(reportId));
    ...
    public void testAcceptReport_Found() {
        ...
        ApiOk response = reportEndpoints.acceptReport(reportId);
    ...
    public void testAcceptReport_NotFound() {
        ...
        NotFoundException exception = assertThrows(NotFoundException.class,
                () -> reportEndpoints.acceptReport(reportId));
