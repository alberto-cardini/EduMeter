...
public class DegreeEndpointsTest {

    @Mock
    private DegreeDAO degreeDAO;

    @InjectMocks
    private DegreeEndpoints degreeEndpoints;
    ...
    public void testGetDegree_Found() {
        ...
        Degree gotDegree = degreeEndpoints.get(id);
    ...
    public void testSearchDegree_All() {
        ...
        List<Degree> gotDegrees = degreeEndpoints.search(query, schoolId);
    ...
    public void testCreateDegree() {
        ...
        ApiObjectCreated response = degreeEndpoints.create(degree);
    ...
    public void testDeleteDegree_Found() {
        ...
        ApiOk response = degreeEndpoints.delete(id);
    ...
    public void testUpdateDegree_Found() {
        ...
        ApiOk response = degreeEndpoints.update(degree);
