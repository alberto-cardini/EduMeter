...
public class AdminEndpointsTest {
    ...
    public void testGetAll() {
        ...
        List<Admin> gotAdmins = adminEndpoints.getAll();
    ...
    public void testGet_Found() {
        ...
        Admin gotAdmin = adminEndpoints.get(id);
    ...
    public void testCreate() {
        ...
        ApiObjectCreated response = adminEndpoints.create(admin);
    ...
    public void testDelete_Found() {
        ...
        ApiOk response = adminEndpoints.delete(id);
