...
public class CourseEndpointsTest {
    ...
    @InjectMocks
    private CourseEndpoints courseEndpoints;
    ...
    public void testGetCourse_Found() {
        ...
        Course gotCourse = courseEndpoints.get(id);
    ...
    public void testSearchCourse_All() {
        ...
        List<Course> gotCourses = courseEndpoints.search(query, schoolId, degreeId);
    ...
    public void testCreateCourse() {
        ...
        ApiObjectCreated response = courseEndpoints.create(course);
    ...
    public void testDeleteCourse_Found() {
        ...
        ApiOk response = courseEndpoints.delete(id);
    ...
    public void testUpdateCourse_Found() {
        ...
        ApiOk response = courseEndpoints.update(course);
    ...
    public void testListTeachings() {
        ...
        List<Teaching> gotTeachings = courseEndpoints.listTeachings(courseId);
    ...
    public void testAddTeaching_Valid() {
        ...
        CourseEndpoints.AddTeachingBody body = new CourseEndpoints.AddTeachingBody(profId);

        when(teachingDAO.add(any(Teaching.class))).thenReturn(expectedTeachingId);

        ApiObjectCreated response = courseEndpoints.addTeaching(courseId, body);
    ...
    public void testAddTeaching_InvalidBody() {
        int courseId = 42;
        // Missing profId (null)
        CourseEndpoints.AddTeachingBody body = new CourseEndpoints.AddTeachingBody(null);

        BadRequestException exception = assertThrows(BadRequestException.class,
                () -> courseEndpoints.addTeaching(courseId, body));
    ...
    public void testRemoveTeaching_Found() {
        ...
        ApiOk response = courseEndpoints.removeTeaching(courseId, teachingId);
    ...
    public void testRemoveTeaching_NotFound() {
        ...
        NotFoundException exception = assertThrows(NotFoundException.class,
                () -> courseEndpoints.removeTeaching(courseId, teachingId));
