...
public class PublishedReviewEndpointsTest {
    ...
    @InjectMocks
    private PublishedReviewEndpoints publishedReviewEndpoints;
    ...
    public void testSearch_Authenticated() {
        ...
        try (MockedConstruction<AuthFilter> mocked = mockConstruction(AuthFilter.class,
            ...
            List<PublishedReview> gotReviews = publishedReviewEndpoints.search(1, 2, 3, 4, ctx);
    ...
    public void testGet_Authenticated_Found() {
        try (MockedConstruction<AuthFilter> mocked = mockConstruction(AuthFilter.class,
            ...
            PublishedReview gotReview = publishedReviewEndpoints.get(id, ctx);
    ...
    public void testGet_Unauthenticated_NotFound() {
        try (MockedConstruction<AuthFilter> mocked = mockConstruction(AuthFilter.class,
            ...
            NotFoundException exception = assertThrows(NotFoundException.class,
                    () -> publishedReviewEndpoints.get(id, ctx));
    ...
    public void testPublish() {
        ...
        ApiObjectCreated response = publishedReviewEndpoints.publish(review, securityContext);
    ...
    public void testToggleVote() {
        try (MockedConstruction<AuthFilter> mocked = mockConstruction(AuthFilter.class,
            ...
            ApiOk response = publishedReviewEndpoints.toggleVote(id, ctx);
    ...
    public void testDelete() {
        try (MockedConstruction<AuthFilter> mocked = mockConstruction(AuthFilter.class,
            ...
            ApiOk response = publishedReviewEndpoints.delete(id, ctx);
    ...
    public void testUpdate() {
        try (MockedConstruction<AuthFilter> mocked = mockConstruction(AuthFilter.class,
            ...
            ApiOk response = publishedReviewEndpoints.update(review, ctx);
