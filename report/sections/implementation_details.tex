...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.7, transform shape]
		...
		\umlinherit[geometry=|-|, anchor1=south, arm1=-0.7]{InMemDAOFactory}{DAOFactory}
		\umlinherit[geometry=|-|, anchor1=south, arm1=-0.7]{PostgreDAOFactory}{DAOFactory}
	\end{tikzpicture}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.8, transform shape]
		...
		\umlclass[above = 1cm of Users]{Pin Challenge}{
			\begin{tabular}{@{} l l l @{}}
				\textbf{PK} & \textbf{id} 	& \textit{int} \\
							& pin	 		& \textit{varchar} \\
		...
		\umlclass[below = 0.3cm of Drafted Review]{Up Vote}{
			\begin{tabular}{@{} l l l @{}}
		...
		\umluniassoc[geometry=-|-]{Report}{Users}
		\umluniassoc[geometry=-|-]{Report}{Published Review}
		...
		\umluniassoc{Pin Challenge}{Users}
		\umluniassoc[geometry=-|-]{Up Vote}{Users}
		\umluniassoc[geometry=--]{Up Vote}{Published Review}
