...
\textbf{EduMeter}'s schema is architected to ensure strict traceability between users and their contributions while maintaining a hierarchical organization of academic data including Schools, Degrees, and Courses. The E-R model (Figure 3) is organized into three functional clusters:
