...
\begin{usecasetable}{1}{Browse Review}
	\begin{tabularx}{\textwidth}{@{} l|X @{}}
		...
		\begin{tabenum}
			...
			\item The system displays a list of reviews (Mock-up \ref{mock-up-2-browsing-page}).
...
\begin{usecasetable}{3}{Submit Review}
	\begin{tabularx}{\textwidth}{@{} l|X @{}}
		...
		\begin{tabenum}
			...
			\item The user confirms the submission (Mock-up \ref{mock-up-7-review-form-b}).
		\end{tabenum} \\
		...
		\textbf{Alternative Steps} & \begin{tabitem}
			...
			\begin{itemize}
				...
				\item Upon submission, the system saves the review but is not published until an Admin approves it (UC \#5: Validate Review Data).
			\end{itemize} 
		\end{tabitem}
	\end{tabularx}
\end{usecasetable}
...
\begin{usecasetable}{4}{Up-Vote}
	\begin{tabularx}{\textwidth}{@{} l|X @{}}
		...
		\textbf{Steps} &
		\begin{tabenum}
			\item The student selects the up-vote option on a specific review.
		...
		\textbf{Alternative Steps} & \begin{tabitem}
			\item[3a.] If the student has already voted, the system interprets the action as a request to retract the vote and remove the existing vote as well as decrementing the total score.
		\end{tabitem}
	\end{tabularx}
\end{usecasetable}
...
\begin{usecasetable}{7}{Validate Review Information}
	\begin{tabularx}{\textwidth}{@{} l|X @{}}
		...
		\begin{tabenum}
			...
			\item The admin approves and publishes the review.
			\item The system creates the new Teaching entry in the database.
		\end{tabenum} \\
		\textbf{Post-conditions} & The review is published and the new Teaching entry is available for future reviews. \\
		\textbf{Alternative Steps} & \begin{tabitem}
			\item[2a.] If the submitted information is invalid or false, the admin discard the review.
